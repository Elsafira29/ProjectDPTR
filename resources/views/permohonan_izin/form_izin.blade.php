                ...
                <form action="{{ route('simpan_administrasi') }}" method="POST" enctype="multipart/form-data" style="width: 100vh; margin-left:10px;">
                  {{ csrf_field() }}
                    ...
                    <div class="form-group mt-3 mt-3">
                      ...
                      <input type="date" id="tgl_masuk" name="tgl_masuk" class="form-control" placeholder="Tangal Masuk" required>
                  </div>
                    <div class="form-group mt-3">
                      <label>Tindak Lanjut</label>
                        <input type="text" id="tindak" name="tindak" class="form-control" placeholder="Tindak Lanjut" required>
                    </div>
                    <div class="form-group mt-3">
                      <label>Pengembalian</label>
                        <input type="text" id="pengembalian" name="pengembalian" class="form-control" placeholder="Pengembalian" required>
                    </div>
                    <div class="form-group mt-3">
                      <label>Proses Kasultanan</label>
                      <input type="text" id="proses_kasultanan" name="proses_kasultanan" class="form-control" placeholder="Proses Kasultanan" required>
                    </div>
                    <div class="form-group mt-3">
                      <label>Jawaban Kasultanan</label>
                      <input type="text" id="jawaban_kasultanan" name="jawaban_kasultanan" class="form-control" placeholder="Jawaban Kasultanan" required>
                    </div>
                    <div class="form-group mt-3">
                      <label>Proses Biro Hukum</label>
                      <input type="text" id="proses_biro" name="proses_biro" class="form-control" placeholder="Proses Biro Hukum" required>
                    </div>
                    <div class="form-group mt-3">
