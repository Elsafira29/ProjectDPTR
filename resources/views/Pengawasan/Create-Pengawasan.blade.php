          ...
          <form action="{{ route('simpan-Pengawasan') }}" method="POST">
            {{ csrf_field() }}
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" id="tahun_pengawasan" name="tahun_pengawasan" class="form-control" required>
                    </div>
                    <div class="form-group mt-3">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" id="bentuk_pemanfaatan" name="bentuk_pemanfaatan" class="form-control" required>
                    </div>
                    <div class="form-group mt-3">
                  ...
                  <div class="form-group mt-3">
                    ...
                    <input type="text" id="luas_pemanfaatan" name="luas_pemanfaatan" class="form-control" required>
                  </div>
                  <div class="form-group mt-3">
                    <label>Luas Keseluruhan:</label>
                    <input type="text" id="luas_keseluruhan" name="luas_keseluruhan" class="form-control" required>
                  </div>
                  <div class="form-group mt-3">
                    <label>Jumlah Bidang	:</label>
                    <input type="text" id="jumlah_bidang" name="jumlah_bidang" class="form-control" required>
                  </div>
                  <div class="form-group mt-3">
                    <label>Lokasi:</label>
                  ...
                  <div class="form-group mt-3">
                    ...
                    <input type="text" id="jenis_sk" name="jenis_sk" class="form-control" required>
                  <div>
                  <div class="form-group mt-3">
                    <label>Tindak Lanjut:</label>
                    <input type="text" id="tdklanjut" name="tdklanjut" class="form-control" required>
                  <div>
                  <div class="form-group mt-3">
                      <label>Kesesuaian:</label>
                      <input type="text" id="kesesuaian" name="kesesuaian" class="form-control" required>
                  <div class="mt-3">
